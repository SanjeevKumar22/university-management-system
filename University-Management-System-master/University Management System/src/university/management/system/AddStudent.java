...
class AddStudent implements ActionListener{
    ...
    JFrame f;
    JLabel id,id1,id2,id3,id4,id5,id6,id7,id8,id9,id10,id11,id12,id15,id16,id17,lab,lab1,lab2,lab3;
	...
	lab2.setFont(new Font("serif",Font.BOLD,20));
        ...
        String branch[] = {"","Computer Science","Electronics","Electrical and electronic","Mechanical","Civil"};
        ...
        lab3=new JLabel("Semester");
        lab3.setBounds(400,450,150,30);

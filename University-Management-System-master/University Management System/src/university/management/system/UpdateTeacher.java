...
class UpdateTeacher implements ActionListener{
    ...
    JFrame f;
    JLabel id,id1,id2,id3,id4,id5,id6,id7,id8,id9,id10,id11,id12,id15,id16,lab,lab1,lab2;
    JTextField t,t1,t2,t3,t4,t5,t6,t7,t8,t9,t10,t11,t12,t13,t14,t15;
    JButton b,b1,b2; 
    String id_emp;

    UpdateTeacher(){
        f=new JFrame("Update Faculty details");
        f.setSize(900,650);
        ...
        id8 = new JLabel("Update Faculty Details:");
	...
	lab2.setFont(new Font("serif",Font.BOLD,20));
        ...
        id16= new JLabel("Subject");
        id16.setBounds(400,420,150,30);
        id16.setFont(new Font("serif",Font.BOLD,20));
        f.add(id16);

        t15=new JTextField();   
        t15.setBounds(600,420,150,30);
        f.add(t15);
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource()==b){
            try{
                conn con = new conn();
                String str = "update teacher set name='"+t1.getText()+"',fathers_name='"+t2.getText()+"',age='"+t3.getText()+"', dob='"+t4.getText()+"',address='"+t5.getText()+"',phone='"+t6.getText()+"',email='"+t7.getText()+"',aadhar='"+t10.getText()+"',course='"+t11.getText()+"',dept='"+t14.getText()+"', emp_id = '"+t13.getText()+"',subject='"+t15.getText()+"' where emp_id='"+t12.getText()+"'";

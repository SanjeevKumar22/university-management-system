...
class AddTeacher implements ActionListener{
    ...
    JFrame f;
    JLabel id,id1,id2,id3,id4,id5,id6,id7,id8,id10,id11,id12,id15,id16,id17,id18,lab,lab1,lab2;
    JTextField t1,t2,t3,t4,t5,t6,t7,t10,t11,t12;
    JButton b,b1,b2,b3;
    JComboBox c1,c2;
	...
	lab2.setFont(new Font("serif",Font.BOLD,20));
        ...
        String branch[] = {"","Computer Science","Electronics","Electrical","Mechanical","Civil","Information Science"};
        ...
        id18= new JLabel("Subject");
        id18.setBounds(400,400,150,30);
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        if(ae.getSource() == b){
            try{
                conn cc = new conn();
                String q = "insert into teacher values('"+a+"','"+bb+"','"+c+"','"+d+"','"+e+"','"+ff+"','"+g+"','"+j+"','"+k+"','"+l+"','"+m+"','"+n+"')";
